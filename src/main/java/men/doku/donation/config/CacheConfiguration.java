...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, men.doku.donation.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, men.doku.donation.repository.UserRepository.USERS_BY_EMAIL_CACHE);
